  ...
  <div class="content-wrapper">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="36 MESES" disabled >
                      </div>
                    </div>
                    </div>
                    <div class="row">
              ...
              <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="form-group">
                        <label>Colonia</label>
                        <input type="text" class="form-control" value="<?php echo $nombre_colonia; ?>" disabled >
                      </div>
                    </div>
    ...
    <!-- /.content -->
                  ...
                  <div class="tab-pane" id="expediente">
                    <form class="form-horizontal">
                      <iframe src="../../../manoplaqr/index.php" width="100%" height="825" style="border:none; overflow:hidden">
                      </iframe>
