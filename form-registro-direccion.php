...
$_SESSION['correo_cte'] = htmlentities ($_POST["correo_cte"]);
...
?>
			...
			<div class="formulario__grupo" id="grupo__nombre">
				<label for="vivienda" class="formulario__label">Tipo de Vivienda</label>
...
<!-- Grupo: Num Inteior -->
		...
		<input type="text" class="formulario__input" name="colonias" id="colonias" autocomplete="off" tabindex="6" required>
...
<input type="text" class="formulario__input" name="municipio" id="municipio" autocomplete="off" tabindex="7" required>
...
<input type="text" class="formulario__input" name="ciudad" VALUE="CDMX"id="ciudad" autocomplete="off" tabindex="8" required> 
