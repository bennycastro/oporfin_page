		...
		if ( $nonce) {
			...
			if($requestMethod == 'GET') {
				...
				function cleanDataArray(&$value,$key,$allowed_html){
					...
					$contentKeysArr = array('accContent', 'widgetTextContent', 'wltc','fbTextContent','formCustomHTML','POcustomCSS','POcustomJS','widgetContent','formCustomHTML','pbPricingContent','content', 'btnText', 'columnContent', 'formBuilderBtnText', 'imgwcap', 'pbCountDownfinishActionJs', 'cnilab','shortCodeInput', 'btnCAction' );
					if(is_array($value)){
						return;
					}
