(function ($) {
  ...
  $(document).on("click", ".confirm_template_yes_replace", function () {
    ...
    if (isConfirmTrue_c == true) {
      ...
      const avlbleTemps = ['temp98', 'temp0', 'temp77', 'temp68', 'temp62', 'temp34', 'temp65', 'temp45', 'temp70', 'temp106', 'temp47', 'temp46', 'temp44', 'temp43', 'tempftp1', 'tempftp2', 'tempftp3', 'tempftp4', 'temp3', 'temp2', 'temp4', 'temp9'];
