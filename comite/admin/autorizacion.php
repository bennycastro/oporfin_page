...
dispersión de los fondos solicitados bajo las siguientes especificaciones</span>
      <table>
        <thead>
          <tr>
        ...
        <tbody>
            ...
            <td class="TOTAL"></td>
              ...
              <tr>
              <td class="fondo-gris">TASA</td>
              <td class="TOTAL"><?php echo "$tasa" ?> %</td>
              <td class="TOTAL"></td>
              </tr> 
